      ...
      >
        ...
        <div className="relative flex-grow">
          ...
          <div
            ...
            style={{ backgroundImage: `url(${bgImage})` }}
          >
            <div className="w-full max-w-md bg-white rounded-t-full shadow-lg relative text-center">
              <img
                src="/chibi.PNG"
                alt="Nofridho & Nadya"
              ...
              <div className="card">
                ...
                >
                  ...
                  <button
                    ...
                    className={`seal bg-rose-500 text-red-800 w-10 aspect-square rounded-full z-40 text-[10px] flex items-center justify-center font-semibold [clip-path:polygon(50%_0%,_80%_10%,_100%_35%,_100%_70%,_80%_90%,_50%_100%,_20%_90%,_0%_70%,_0%_35%,_20%_10%)] border-4 border-rose-900 transition-all duration-1000 ${
                  ...
                  <div
                    className={`tp transition-all duration-300 ${
                      isOpen ? "duration-100" : ""
                    } bg-pink-200 absolute w-full h-full ${
                      isOpen
                  ...
                  {/* Left Triangle */}
                  <div
                    className={`lft transition-all duration-700 absolute w-full h-full bg-pink-300 [clip-path:polygon(50%_50%,_0_0,_0_100%)] ${
                  ...
                  {/* Right Triangle */}
                  <div
                    className={`rgt transition-all duration-700 absolute w-full h-full bg-pink-300 [clip-path:polygon(50%_50%,_100%_0,_100%_100%)] ${
                      isOpen
                  ...
                  {/* Bottom Triangle */}
                  <div
                    className={`btm transition-all duration-700 absolute w-full h-full bg-pink-200 [clip-path:polygon(50%_50%,_100%_100%,_0_100%)] ${
                      isOpen
            ...
            >
              <div className="p-6 rounded-lg shadow-lg max-w-md w-full text-center border border-gray-300">
                ...
                <form className="space-y-3">
                  ...
                  {/* Dua Button untuk Hadir/Tidak Hadir */}
